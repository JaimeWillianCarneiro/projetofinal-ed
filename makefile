...
avl: main_avl.o avl.o tree_utils.o data.o bst.o rbt.o 
	$(CXX) $(CXXFLAGS) -o $@ $^
...
bst: main_bst.o bst.o tree_utils.o data.o avl.o rbt.o 
	$(CXX) $(CXXFLAGS) -o $@ $^
...
# ============================
tree_utils.o: src/tree_utils.cpp src/tree_utils.h src/avl.h src/bst.h src/rbt.h 
